...
public class MainPage {
    ...
    public SelenideElement shoppingCartLink = Selenide.$x("//*[@data-test='shopping-cart-badge']");
    public SelenideElement addToCartBackpack = Selenide.$x("//*[@data-test='add-to-cart-sauce-labs-backpack']");
    public SelenideElement burgerMenu = Selenide.$x("//*[@id='react-burger-menu-btn']");
